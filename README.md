...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ut8rylu.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ut8rylu.containers.anotherwebservice.com/
...
```
git clone git@github.com:tide-e/container-ut8rylu.git
cd container-ut8rylu
```
...
```
docker attach container-ut8rylu
```
